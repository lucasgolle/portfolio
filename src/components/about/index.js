  ...
  return (
    <Container>
      <h1>Um pouco sobre mim</h1>
        ...
        <p>Olá, me chamo Lucas Golle. Sou estudante de Ciência da Computação e
          ...
          outro lado, desenvolvendo essas ferramentas fantásticas.</p>
        <div>
        <h2>Perfil</h2>
        <p>Apaixonado por tecnologia, games, Harry Potter.</p>
        </div>
    </Container>
  );
};
